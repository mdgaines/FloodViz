...
country_df = pd.read_csv('../data/countries_continents_update.csv', encoding='latin-1')
country_dict = dict(zip(country_df['Country'],country_df['Continents']))

emdat_df = pd.read_csv("../data/emdat_public_20230710.csv", encoding='latin-1')
...
dfo_df = pd.read_csv("../data/dfo_FloodArchive_20230710.csv", encoding='latin-1')
...
plt.savefig('../imgs/dfo_emdat_20230714.png', dpi=300, facecolor='w', edgecolor='w')
